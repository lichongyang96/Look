...
public class ZhihuThemeContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context mContext;
    private LayoutInflater inflater;
    private ArrayList<ZhihuThemeStory> stories;

    public ZhihuThemeContentAdapter(Context context){
    ...
    public void showLeastContent(ArrayList<ZhihuThemeStory> newStories){
    ...
    private class ItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bindItem(final ZhihuThemeStory story){
